...
export function AdminPageFooter({status, actions}: AdminPageFooterProps) {
  return (
    <div className="mx-6 mb-6 lg:mx-8 lg:mb-8 rounded-xl border border-border bg-surface-elevated px-6 py-3 shadow-sm flex items-center justify-between gap-4">
